...
/// Simple storage of data from a NFF file.
class NFFStore : public NFFCallbacks
{
public: // data
	...
	public: // methods
		Material(const nff_col3 &xcol, float xkd, float xks, float xshine, float xT, float xior) : col(xcol), kd(xkd), ks(xks), shine(xshine), T(xT), ior(xior) {}
	};
	...
	public: // methods
		MaterialGroup(const nff_col3 &xcol, float xkd, float xks, float xshine, float xT, float xior) : material(xcol, xkd, xks, xshine, xT, xior) {}
	};
...
public: // methods
	...
	public: // methods
		TD(const nff_vec3 &v0, const nff_vec3 &v1, const nff_vec3 &v2, int d) : t(v0, v1, v2), depth(d) {}
	};
